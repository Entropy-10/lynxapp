  ...
  return (
    <div className='mb-3 relative flex items-center'>
      <div>
        ...
        <input type='text' placeholder='Search' ref={inputElement} value={props.searchTerm} onChange={getSearchTerm} className='bg-lynx-light text-lynx-text-light focus:outline-none rounded-md py-1 pl-7 pr-48' />
      </div>
