...
import SelectMenu from '../compontents/SelectMenu';
...
export default function Settings() {
  ...
  function handleDeleteButtonClick(index) {
    const masterSchedule = store.get('masterSchedule');
    ...
    <div className="mt-10 h-1">
      <div>
        ...
        <div className="flex">
          ...
          <button className="bg-lynx-bg-very-dark hover:text-lynx-text-dark px-3 ml-16 rounded-lg ">Update Players</button>
        </div>
      </div>
      
      <div className="w-3/4 h-0.5 bg-white my-10"></div>
      ...
      <div>
        ...
        <div className="flex">
          <input className="bg-lynx-bg-very-dark focus:outline-none rounded-lg pl-2" type="text" placeholder="Enter Sheet Id..."></input>
          <div className="bg-lynx-bg-very-dark rounded-lg px-3 pr-6 py-2 w-56 truncate relative ml-14">
        ...
        <div className="mt-5">
          ...
          <div className="flex">
            ...
            <button className="bg-lynx-bg-very-dark hover:text-lynx-text-dark px-3 ml-16 rounded-lg ">Update Sheets</button>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex">
          <input value={inputValue} onChange={(event) => setInputValue(event.target.value)} className="bg-lynx-bg-very-dark focus:outline-none rounded-lg pl-2" type="text" placeholder="Enter Name..."></input>

          <div className="ml-8">
            <DatePicker className="bg-lynx-bg-very-dark rounded-lg pl-5 w-28 flex" selected={startDate} onChange={(date) => setStartDate(date)} />
          </div>
        ...
        <div className="mt-2">
          {store.get('masterSchedule')?.map((event, index) => (
            <div className="flex mt-1" key={index}>
              <div className="w-48 pl-2 truncate rounded-lg bg-lynx-bg-mid-dark text-lynx-text-dark">{event.event}</div>
              <div className="ml-8 bg-lynx-bg-mid-dark text-lynx-text-dark rounded-lg pl-3 w-28">{moment(event.date).format('MMM Do, YYYY')}</div>
